...
$('document').ready(function () {
  /* Listening for changes on each amenities INPUT checkbox tag */
  const amenitiesId = {};
  ...
  /* Listening for changes on each states INPUT checkbox tag */
  const statesId = {};
  const citiesId = {};
  const citiesStates = {};
  ...
  /* Listening for changes on each cities INPUT checkbox tag */
  ...
  */
  ...
  callout();
  /*
    Retrieving all places and create a articule tag with them
  */
  ...
  getPlaces();
  /*
    Filtering places by amenities on button search click
  */
